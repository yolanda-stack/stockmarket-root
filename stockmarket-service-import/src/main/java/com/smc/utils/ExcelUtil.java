...
//        System.out.println(sheet.getRow(rowLength).getCell(3).getDateCellValue().getTime());
//        System.out.println(timeFormat.parse(sheet.getRow(rowLength).getCell(4).getStringCellValue().trim()).getTime());
//        String toDate = ""+new Date(sheet.getRow(rowLength).getCell(3).getDateCellValue().getTime())+" "+new Time(timeFormat.parse(sheet.getRow(rowLength).getCell(4).getStringCellValue().trim()).getTime());
        String toDate = ""+new Date(row.getCell(3).getDateCellValue().getTime())+" "+new Time(timeFormat.parse(row.getCell(4).getStringCellValue().trim()).getTime());
